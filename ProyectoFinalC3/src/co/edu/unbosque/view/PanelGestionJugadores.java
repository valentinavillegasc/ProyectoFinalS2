...
public class PanelGestionJugadores extends JPanel {
    ...
    public PanelGestionJugadores() {
        setLayout(new BorderLayout());
        inicializarComponentes();
        setBorder(new TitledBorder("Gestión Jugadores"));
    ...
    private void inicializarComponentes() {
        ...
        // --- Título visual ---
        JLabel lblTitulo = new JLabel("Gestión Jugadores", SwingConstants.CENTER);
        ...
        btnAgregar.setActionCommand("AgregarJugador");
        ...
        Object[][] datos = {}; // Vacío inicialmente
